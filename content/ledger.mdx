...
Click **Show filters** for the full set: date range (with presets and a custom range), direction (money in / money out), partner, company, bank account and currency, invoice categories, transaction types, and more under **More filters**. Everything you've applied appears as removable chips under **Active filters** - click the **×** on a chip to drop just that one, or **Clear** to reset.
