...
For invoices in a currency other than the company's VAT-reporting currency, lines carry a **VAT exchange rate** and a **VAT amount in reporting currency**. Editing either recalculates the other, and both are available in exports.
