...
Invoices flagged as **Duplicate** or **Review** carry a badge next to the invoice number. Invoices without an assigned company carry a **Company needed** badge.
...
- **Keep company records up to date.** The AI uses company names, tax IDs, and alternative names to identify partners. If a supplier appears as unknown, add them to Master Data → Companies with their correct name and tax ID.
