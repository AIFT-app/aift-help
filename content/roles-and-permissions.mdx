...
System roles cannot be edited. Click **View** on a role to see, read-only, what a member on that role can do. To give an accountant or a client user a different set, create a custom role or add an exception.
...
| Edit header (direction, company, partner) | ✓ | ✓ | — | — |
