...
2. Click **Upload statement** in the top-right corner - or simply drag one or more PDFs (or a `.zip` of them) onto the page.
3. Select your PDF file(s) in the picker if you used the button.
...
For the full upload mechanics - multi-file picker, drag-and-drop, ZIP archives, retrying failed extractions - see [Uploading Files](/uploading-files).
...
If the bank account does not exist yet in your workspace but the account is listed under one of your companies in **Master Data → Companies**, the account is created automatically and linked to that company.
...
2. Categorisation and partner resolution run automatically - the same AI pipeline used for open banking transactions.
...
- **Match accounts before uploading.** If you add bank account details under **Master Data → Companies** before uploading, the statement will match automatically - no manual assignment needed.
