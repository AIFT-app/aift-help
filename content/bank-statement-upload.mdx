...
Click any completed statement row in the Statements tab to open the detail page. This shows the PDF on the left and the extracted transaction list on the right.

- **Click a transaction row** to jump to the corresponding page in the PDF viewer.
