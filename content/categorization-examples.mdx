...
- **Accounting categories** → open the **Examples** tab, then pick **Invoice examples** or **Cash examples** at the top of the tab.
- **Transaction types** → open the **Examples** tab for what AIFT has learned about which transactions need no invoice at all. See [Transaction Types & No Invoice Needed](/transaction-types) for that one.

On the Accounting categories page, Examples is the third tab next to the Invoice and Cash lists. The Transaction types page has two tabs at the top: the list you already know, and **Examples**.
...
| **Verdict** | Transaction-type examples only: **No invoice needed** or **Needs an invoice** |
...
- [Transaction Types & No Invoice Needed](/transaction-types) - the same learning loop, applied to which transactions need a document at all.
