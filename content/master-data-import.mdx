...
On the **Review** step you see three counts before anything is created: how many categories will be income, how many expense, and how many usable for both. Each row shows its direction. If some direction cells could not be read, an amber note says how many.
