...
Once connected, you can ask your assistant questions in plain language ("What invoices in TechBridge need my attention?") and it will pull live data from your AIFT workspace. With the optional write scope, it can also categorise transactions, accept matches, and edit invoice fields for you.
...
> "In TechBridge, what bank transactions in May don't have a matching invoice yet?"

> "Show me Q1 results for TechBridge — both the P&L and cash-flow reports."

> "Which Agrocsoport invoices have uncategorised line items, sorted by amount?"

> "Find every Telekom bank transaction in MVP Kft. from March."
...
> "This invoice's counterparty is wrong — set it to the verified partner 'Magyar Telekom'."
...
| **Make changes** | Categorise invoices and bank transactions, accept and undo matches, edit invoice direction / counterparty / entity, link or verify partners, mark transactions as no-invoice-needed. Each action is recorded with before/after values. |
...
- **Be specific about the workspace.** "Show me Agrocsoport's…" is much better than "Show me my client's…". The assistant has access to all your workspaces and will sometimes guess.
