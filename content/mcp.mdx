...
|---|---|
| **Read your books** | Every read tool: list workspaces, search the ledger, view invoices and transactions, list partners and companies, run reports, etc. No mutations. |
| **Make changes** | Categorise invoices and bank transactions, accept and undo matches, edit invoice direction / partner / company, link or verify partners, mark transactions as no-invoice-needed. Each action is recorded with before/after values. |
