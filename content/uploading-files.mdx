...
Prefer to skip the upload step entirely? You can also [forward documents to your workspace by email](/email-forwarding) and they'll be captured automatically.
