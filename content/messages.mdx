...
- Someone on the **client side** writing on a record reaches the accounting team.

There's no separate recipient to pick - you write on the record, and the people on the other side see it. Every message shows the sender's name and a role badge (**Accountant**, **Accountant admin**, **Finance lead**, **Finance admin** or **Team member**) so it's always clear who said what.

## Writing a message about a record

Open any invoice, transaction, statement, match, company, or partner. The **Messages** panel sits on the detail page (and in the transaction slide-over). To start or continue a conversation:
