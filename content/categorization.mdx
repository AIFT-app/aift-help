...
Accountants can see, edit, and pre-load what the AI has learned on the **Examples** tab of the invoice and cash category pages — see [How AIFT Learns Your Categories](/categorization-examples).
