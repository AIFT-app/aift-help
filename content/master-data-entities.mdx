...
Both identifiers help recognise the company on incoming documents: an invoice that shows **either** the domestic Tax ID or the EU VAT number will still identify the entity correctly — and for your own entities, book the document as income or expense in the right direction.
