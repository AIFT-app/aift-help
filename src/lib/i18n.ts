...
export const ui: Record<Locale, Record<string, string>> = {
  en: {
    ...
    searchNoResultsHint: 'Check the spelling, or try a shorter search term.',
    searchEmpty: 'Start typing to search every article.',
    searchLoading: 'Loading search…',
    searchError: 'Search is unavailable right now.',
    searchInEnglish: 'in English',
    searchNavigate: 'to navigate',
    searchSelect: 'to open',
  ...
  hu: {
    ...
    searchNoResultsHint: 'Ellenőrizze a helyesírást, vagy próbáljon rövidebb keresőszót.',
    searchEmpty: 'Kezdjen el gépelni, és az összes cikkben keresünk.',
    searchLoading: 'Keresés betöltése…',
    searchError: 'A keresés jelenleg nem érhető el.',
    searchInEnglish: 'angolul',
    searchNavigate: 'navigálás',
    searchSelect: 'megnyitás',
    searchClose: 'bezárás',
    enlarge: 'Nagyítás',
  ...
  de: {
    ...
    searchNoResultsHint: 'Prüfen Sie die Schreibweise oder versuchen Sie einen kürzeren Suchbegriff.',
    searchEmpty: 'Tippen Sie, um alle Artikel zu durchsuchen.',
    searchLoading: 'Suche wird geladen…',
    searchError: 'Die Suche ist derzeit nicht verfügbar.',
    searchInEnglish: 'auf Englisch',
    searchNavigate: 'zum Navigieren',
    searchSelect: 'zum Öffnen',
    searchClose: 'zum Schließen',
    enlarge: 'Vergrößern',
    enlargeClose: 'Schließen',
  },
}
